...
def is_swap(player_score, opponent_score):
    ...
    if opponent_score >= 100:
    	opponent_score -= 100
    abs_player = abs(player_score % 10 - player_score // 10)
    abs_opponent = abs(opponent_score % 10 - opponent_score // 10)
    return abs_player == abs_opponent
    # END PROBLEM 4

def score_swap(p1, p2):
	p1 += p2
	p2 = p1-p2
	p1 = p1-p2
	return p1, p2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
    	...
    	player = other(abs(player))
    	"""score0 += take_turn(strategy0(score0, score1), score1, dice)

    	if is_swap(score0, score1):
    		score0, score1 = score_swap(score0, score1)
